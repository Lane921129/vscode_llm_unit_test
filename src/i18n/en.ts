export default {
    ui: {
        ...
        file: "File",
        function: "Function",
        prepareEnvironment: "Check and prepare Python environment",
        pythonEnvironment: "Python environment result",
        currentPython: "Current Python (target dependencies not checked yet): ",
        prepareEnvironmentHint: "Reuse an installed environment first; install missing requirements or individual packages into the selected environment.",
