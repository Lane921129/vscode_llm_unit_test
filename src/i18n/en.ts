export default {
    ui: {
        ...
        prepareEnvironmentHint: "Check Python dependencies in the project above. Package names are filled in for confirmation and pip installation. Other scope supports a folder or single file.",
