export default {
    ui: {
        ...
        file: "File",
        allFiles: "all (entire project)",
        function: "Function",
        prepareProjectEnvironment: "Check project dependencies",
        prepareEnvironment: "Other scope…",
        pythonEnvironment: "Python environment result",
        currentPython: "Current Python (target dependencies not checked yet): ",
        prepareEnvironmentHint: "Missing packages open an installation list; installation requires confirmation. Version conflicts and import side effects show diagnostics. Starting a test never installs packages. Other scope supports a folder or single file.",
